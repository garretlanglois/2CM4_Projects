...
m_r_t =   if ( t < tfuel1) then (start_mass - q1*t) else (if  ( t < tfuel2)  then (start_mass - (q1*tfuel1 + q2*t)-m_engine-30) else start_mass - mfuel1 - mfuel2-m_engine-30) !mass rocket total
thresh = (L*h)/t0
Tvar = t0 - L*h
